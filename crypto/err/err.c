...
static const ERR_STRING_DATA ERR_str_reasons[] = {
    ...
    /*
     * New machine-readable error codes.
     */
    { ERR_R_OVERFLOW, "overflow" },
    { ERR_R_SELF_TEST_FAILURE, "self test failure" },
    { ERR_R_SECURITY_VIOLATION, "security violation" },
    { ERR_R_CONFIG_ERROR, "configuration error" },
    { ERR_R_INSUFFICIENT_RESOURCES, "insufficient resources" },
    { ERR_R_NOT_FOUND, "not found" },
    { ERR_R_MISSING_REQUIRED_DATA, "missing required data" },
    { ERR_R_NOT_INITIALIZED, "not initialized" },
    { ERR_R_ALREADY_INITIALIZED, "already initialized" },
    { ERR_R_IN_USE, "already in use" },
    { ERR_R_UNKNOWN, "unknown" },
    { ERR_R_NOT_IMPLEMENTED, "not implemented" },
    { ERR_R_DEPRECATED, "deprecated" },
    { ERR_R_UNEXPECTED_EOF, "unexpected end of data" },
    { ERR_R_TIMEOUT, "operation timed out" },
    { ERR_R_MISMATCH, "mismatch" },
    { ERR_R_NO_MATCH, "no match found" },
    { ERR_R_FILE_NOT_FOUND, "file not found" },
    { ERR_R_ENCODING_ERROR, "encoding error" },
    { ERR_R_PARSE_ERROR, "parse error" },
    { ERR_R_DUPLICATE, "duplicate" },
    { ERR_R_CALLBACK_FAILED, "callback failed" },
    { ERR_R_EXPIRED, "expired" },
    { ERR_R_INVALID_KEY, "invalid key" },
    { ERR_R_INVALID_CERTIFICATE, "invalid certificate" },
    { ERR_R_INVALID_FORMAT, "invalid format" },
    { ERR_R_INVALID_LENGTH, "invalid length" },
    { ERR_R_INVALID_ALGORITHM, "invalid algorithm" },
    { ERR_R_WRONG_TYPE, "wrong type" },
    { ERR_R_WRONG_STATE, "wrong state" },
    { ERR_R_CONFLICT, "conflict" },
    { ERR_R_CONNECTION_FAILED, "connection failed" },
    { ERR_R_PROTOCOL_ERROR, "protocol error" },
    { ERR_R_HANDSHAKE_FAILURE, "handshake failure" },
    { ERR_R_BAD_DATA, "bad data" },
    { ERR_R_VERIFICATION_FAILED, "verification failed" },
    { ERR_R_CERTIFICATE_VERIFICATION_FAILED,
        "certificate verification failed" },
    { ERR_R_IO_ERROR, "I/O error" },
    { 0, NULL },
};
#endif
